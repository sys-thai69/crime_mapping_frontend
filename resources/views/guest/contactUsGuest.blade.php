  ...
  <div class="container mt-5">
    <div class="row justify-content-center align-items-center min-h-custom">
      ...
      <div class="col-md-8 form-container">
        <form action="{{ route('contact.guestSubmit') }}" method="POST">
          @csrf
          <div class="row">
            <div class="col-md-6 mb-3">
              <label for="full_name" class="form-label">Full Name</label>
              <input type="text" class="form-control bg-transparent border border-gray-300" id="full_name" name="full_name" required>
            </div>
            <div class="col-md-6 mb-3">
              <label for="email_address" class="form-label">Email Address</label>
              <input type="email" class="form-control bg-transparent border border-gray-300" id="email_address" name="email_address" required>
            </div>
          </div>
          <div class="mb-3">
